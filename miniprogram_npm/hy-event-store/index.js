...
__DEFINE__(1648916697803, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648916697804,"./event-store":1648916697805}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648916697804, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648916697805, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648916697804,"./utils":1648916697806}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648916697806, function(require, module, exports) {
...
return __REQUIRE__(1648916697803);
})()
