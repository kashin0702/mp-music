...
__DEFINE__(1647007560147, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647007560148,"./event-store":1647007560149}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647007560148, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647007560149, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647007560148,"./utils":1647007560150}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647007560150, function(require, module, exports) {
...
return __REQUIRE__(1647007560147);
})()
