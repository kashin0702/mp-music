...
__DEFINE__(1649245306091, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1649245306092,"./event-store":1649245306093}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649245306092, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1649245306093, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1649245306092,"./utils":1649245306094}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649245306094, function(require, module, exports) {
...
return __REQUIRE__(1649245306091);
})()
