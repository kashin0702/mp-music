...
__DEFINE__(1647506091494, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647506091495,"./event-store":1647506091496}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647506091495, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647506091496, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647506091495,"./utils":1647506091497}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647506091497, function(require, module, exports) {
...
return __REQUIRE__(1647506091494);
})()
