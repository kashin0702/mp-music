...
__DEFINE__(1646982861777, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1646982861778,"./event-store":1646982861779}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646982861778, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1646982861779, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1646982861778,"./utils":1646982861780}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646982861780, function(require, module, exports) {
...
return __REQUIRE__(1646982861777);
})()
